...
### [我的博客在这里 &rarr;](http://blog.wxhao2.com)

![](http://wxhao2.duapp.com/blog/readme/blog-desktop.png)
...
```
# Site settings
title: Wxhao Blog             # 你的博客网站标题
SEOTitle: Wxhao Blog			# 在后面会详细谈到
description: "Cool Blog"    # 随便说点，描述一下

# SNS settings      
github_username: wxhao911     # 你的github账号
weibo_username: wxhao911      # 你的微博账号，底部链接会自动更新的。
...
看右边:
![](http://wxhao2.duapp.com/blog/readme/blog-sidebar.png)
...
sidebar-avatar: /img/avatar-wxhao.jpg     #你的大头贴，请使用绝对地址.
```
...
![](http://wxhao2.duapp.com/blog/readme/blog-keynote.png)
...
我的博客标题是 **“wxhao Blog”** 但是我想要在搜索的时候显示 **“吴嘉图的博客 | Wxhao Blog”** ，这个就需要SEO Title来定义了。

其实这个SEO Title就是定义了<head><title>标题</title></head>这个里面的东西和多说分享的标题，你可以自行修改的。

## 致谢
1. [原创黄玄的博客](huxpro.github.io)
